...
class IceMeltAnimation:
    def __init__(self, root):
        ...
        self.images = [
            self.resize_image(os.path.join("C:", "ice_stage_1.png")),
            self.resize_image(os.path.join("C:", "ice_stage_2.png")),
            self.resize_image(os.path.join("C:", "ice_stage_3.png")),
            self.resize_image(os.path.join("C:", "ice_stage_4.png"))
        ]
        self.image_index = 0
    ...
    def setup_gui(self):
        ...
        background_image_path = os.path.join("C:", "background.png")
